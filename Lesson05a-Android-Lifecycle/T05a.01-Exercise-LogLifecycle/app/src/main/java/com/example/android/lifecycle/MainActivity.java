...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logAndAppend("[onCreate] 0, message from onCreate");
    }
    ...
    protected void onStart() {
        super.onStart();
        logAndAppend("[onStart] 1, message from onStart");
    }
    ...
    protected void onResume() {
        super.onResume();
        logAndAppend("[onResume] 2, message from onResume");
    }
    ...
    protected void onPause() {
        super.onPause();
        logAndAppend("[onPause] 3, message from onPause");
    ...
    protected void onStop() {
        super.onStop();
        logAndAppend("[onStop] 4, message from onStop");
    }
    ...
    protected void onRestart() {
        super.onRestart();
        logAndAppend("[onRestart] 5, message from onRestart");
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        logAndAppend("[onDestroy] 6, message from onDestroy");
    }
