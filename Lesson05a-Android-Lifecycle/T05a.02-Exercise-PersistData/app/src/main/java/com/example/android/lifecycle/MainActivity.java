...
public class MainActivity extends AppCompatActivity {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String lifeCycleDysplayTextViewContents = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, lifeCycleDysplayTextViewContents);
    }
